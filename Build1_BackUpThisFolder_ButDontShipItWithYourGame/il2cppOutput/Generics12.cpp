...
IL_0000:
	...
	{// begin try (depth: 1)
		...
		IL2CPP_LEAVE(0x20, FINALLY_000d);
	}// end try (depth: 1)
...
IL_0012:
	{
		...
		V_3 = L_6;
		int32_t L_7 = V_3;
		((Iterator_1_t99A1802EE86A3D5BF71B2DDB37F159C4AFA448EA*)__this)->____state_1 = ((int32_t)il2cpp_codegen_add((int32_t)L_7, (int32_t)1));
		int32_t L_8 = V_3;
		V_0 = L_8;
...
{
	{
		NullCheck((Subsystem_1_t75B62C9B687446D6D9E3C8FB0A841F2CC5A174C8*)__this);
