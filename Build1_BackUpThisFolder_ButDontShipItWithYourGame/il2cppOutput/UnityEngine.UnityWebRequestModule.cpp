...
IL_0083:
	...
	}
	{
		...
		NullCheck(L_31);
		Il2CppChar L_34;
		L_34 = String_get_Chars_mC49DF0CD2D3BE7BE97B3AD9C995BE3094F8E36D3(L_31, ((int32_t)il2cpp_codegen_add((int32_t)L_33, (int32_t)1)), NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* WWWTranscoder_Decode_mE374CCDECF9DC94BDEF4E4864A1A866EA6E0517E (ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* ___input0, uint8_t ___escapeChar1, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* ___space2, const RuntimeMethod* method)
{
	...
	int32_t G_B7_0 = 0;
	{
		...
		MemoryStream__ctor_m9E93692A2BB0E34119603FF6A5D44F6A132052E8(L_1, ((int32_t)((int32_t)(((RuntimeArray*)L_0)->max_length))), /*hidden argument*/NULL);
		V_0 = L_1;
	}
...
IL_000f:
		{
			...
			int32_t L_3 = V_1;
			ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* L_4 = ___space2;
			il2cpp_codegen_runtime_class_init_inline(WWWTranscoder_t551AAF7200BB7381823C52321E9A60A9EE63641B_il2cpp_TypeInfo_var);
			bool L_5;
			L_5 = WWWTranscoder_ByteSubArrayEquals_mDF73859DE753AC7A72BFB1EA7A680B0A044E3539(L_2, L_3, L_4, NULL);
			V_2 = L_5;
			bool L_6 = V_2;
			if (!L_6)
			{
...
IL_001c:
		{
			int32_t L_7 = V_1;
			ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* L_8 = ___space2;
			NullCheck(L_8);
			...
			NullCheck(L_9);
			VirtualActionInvoker1< uint8_t >::Invoke(26 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_9, (uint8_t)((int32_t)32));
			goto IL_006c;
		}
...
IL_0046:
		{
			...
			il2cpp_codegen_runtime_class_init_inline(WWWTranscoder_t551AAF7200BB7381823C52321E9A60A9EE63641B_il2cpp_TypeInfo_var);
			uint8_t L_23;
			L_23 = WWWTranscoder_Hex2Byte_m2613586F9B456371D972483BB2E1FF55951FE36A(L_20, L_22, NULL);
			NullCheck(L_19);
			VirtualActionInvoker1< uint8_t >::Invoke(26 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_19, L_23);
			goto IL_006c;
		}
...
IL_0060:
		{
			...
			NullCheck(L_24);
			VirtualActionInvoker1< uint8_t >::Invoke(26 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_24, L_28);
		}
...
IL_007d:
		{
			...
			L_34 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(30 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_33);
			V_5 = L_34;
			IL2CPP_LEAVE(0x146, FINALLY_0087);
		}
	}// end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
...
IL_0001:
	...
	{// begin try (depth: 1)
		...
		IL2CPP_LEAVE(0x26, FINALLY_0012);
	}// end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
		__last_unhandled_exception = (Exception_t*)e.ex;
